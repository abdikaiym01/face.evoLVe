...
configurations = {
    1: dict(
        ...
        DATA_ROOT = 'datasets/oz_test/casia_faces', # the parent root where your train/val/test data are stored
        ...
        BACKBONE_NAME = 'IR_18', # support: ['ResNet_50', 'ResNet_101', 'ResNet_152', 'IR_50', 'IR_101', 'IR_152', 'IR_SE_50', 'IR_SE_101', 'IR_SE_152']
        HEAD_NAME = 'ArcFace', # support:  ['Softmax', 'ArcFace', 'CosFace', 'SphereFace', 'Am_softmax']
        LOSS_NAME = 'Softmax', # support: ['Focal', 'Softmax']

        INPUT_SIZE = [32, 32], # support: [112, 112] and [224, 224]
        RGB_MEAN = [0.5], # for normalize inputs to [-1, 1]
        RGB_STD = [0.5],
        ...
        MOMENTUM = 0.9,
        STAGES = [20, 25, 30], # epoch stages to decay learning rate
